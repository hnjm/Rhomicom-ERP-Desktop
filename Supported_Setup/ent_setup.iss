...
#define MyAppName "Rhomicom ERP V1 (Full Edition)"
#define MyAppPatchName "Rhomicom ERP V1.4.1 (Full Edition)"
...
AppId={{0A0F2525-693A-47DF-AFDE-4C568B9220D0}}
...
DefaultDirName={sd}\RhomicomERP_V1
DefaultGroupName={#MyAppName}
OutputBaseFilename=REMS V1.4.1 (FE) Setup
SourceDir=C:\RICHARD\RHOAPPS\RHO_ERP_DESKTOP\Supported_Setup\REMS.V1.P41.Setup.Full.Edition
OutputDir=C:\RICHARD\RHOAPPS\RHO_ERP_DESKTOP\Supported_Setup\REMS.V1.P41.Setup.Full.Edition
...
[Registry]
Root: HKLM; Subkey: "SOFTWARE\Rhomicom ERP V1"; ValueType: string; ValueName: "InstallPath"; ValueData: "{app}"; Permissions: admins-full; Flags: uninsdeletekey createvalueifdoesntexist
Root: HKLM; Subkey: "SOFTWARE\Rhomicom ERP V1"; ValueType: string; ValueName: "Executable"; ValueData: "{#MyAppExeName}"; Permissions: admins-full; Flags: uninsdeletekey createvalueifdoesntexist
